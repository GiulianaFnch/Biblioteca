...
?>
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                            ...
                            while ($linha = mysqli_fetch_assoc($resultado)) {
                                ...
                                echo "<td>
                                    <form action='alterar.php' method='post'>
                                        <input type='hidden' name='autor_id' value='" . $linha['autor_id'] . "'>
                ...
                <a href='inserir.php'><button type="button" class='btn btn-sm btn-outline-primary'>Adicionar Autor</button></a>
            </main>
